...
def resource_path(relative_path):
    """Mendapatkan path file saat diakses dari source dan saat dibundel dengan PyInstaller."""
...
apple = pygame.image.load(resource_path('Graphics/buah_naga.png')).convert_alpha()
game_font = pygame.font.Font(resource_path('Font/PoetsenOne-Regular.ttf'), 25)

pygame.mixer.music.load(resource_path('Sound/backsound.mp3'))
pygame.mixer.music.play(-1)
game_over_sound = pygame.mixer.Sound(resource_path('Sound/gameover.mp3'))

# Menu function
def draw_menu():
    menu_font = pygame.font.Font(resource_path('Font/PoetsenOne-Regular.ttf'), 50)
    button_font = pygame.font.Font(resource_path('Font/PoetsenOne-Regular.ttf'), 30)
    title_surface = menu_font.render('Permainan Ular Naga', True, (255, 255, 255))
    ...
    play_button.center = (cell_number * cell_size // 2, cell_number * cell_size // 2)

    pygame.draw.rect(screen, (0, 100, 0), play_button, border_radius=12)
    play_text = button_font.render('Mainkan', True, (255, 255, 255))
...
while True:
    ...
    if show_menu:
        ...
        game_font_big = pygame.font.Font(resource_path('Font/PoetsenOne-Regular.ttf'), 50)
        over_text = game_font_big.render('GAME OVER', True, (255, 0, 0))
        retry_text = game_font.render('Tekan SPASI untuk bermain lagi', True, (0, 0, 0))
        screen.blit(over_text, over_text.get_rect(center=(cell_number * cell_size // 2, cell_number * cell_size // 3)))
        screen.blit(retry_text, retry_text.get_rect(center=(cell_number * cell_size // 2, cell_number * cell_size // 2)))
    else:
